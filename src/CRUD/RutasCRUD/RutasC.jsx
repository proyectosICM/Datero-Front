...
export function RutasC() {
  ...
  return (
    <div className="container-crud">
      ...
      {tablaSeleccionada === "Habilitados" && <RutasTabla il={id} url={urlH} abrir={abrir} cerrar={handleCerrarModal} />}
      {tablaSeleccionada === "Deshabilitados" && <RutasTabla il={id} url={urlD} abrir={abrir} cerrar={handleCerrarModal} />}
      {tablaSeleccionada === "Todos" && <RutasTabla il={id} url={urlT} abrir={abrir} cerrar={handleCerrarModal} />}
    </div>
  );
}